...
Julia must be installed properly with package PyCall. This here is a Julia main program that uses pymhlib
for the MAXSAT problem instance and metaheuristics but julia-maxsat.jl for the concrete solution class
...
maxsat = pyimport("mhlib.demos.maxsat")

include("julia-maxsat.jl")
# using  JuliaMAXSAT

common = pyimport("mhlib.demos.common")
settings = pyimport("mhlib.settings")
